...
public final class LoginFail extends L2LoginServerPacket
{
	public static enum LoginFailReason
	{
		...
		// 15 — Due to high server traffic, your login attempt has failed. Please try
		// again soon.
		...
		// 34 unused
		REASON_DUAL_BOX(35),
		REASON_ACCOUNT_INACTIVE(36), // Your account is currently inactive because you have not
										// logged ...
