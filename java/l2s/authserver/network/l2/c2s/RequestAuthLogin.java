...
/**
 * Format: b[128]ddddddhc b[128]: the rsa encrypted block with the login an
 * password
 */
public class RequestAuthLogin extends L2LoginClientPacket
{
	...
	protected void runImpl() throws Exception
	{
		...
		/*
		 * int ncotp = decrypted[0x7c]; ncotp |= decrypted[0x7d] << 8; ncotp |=
		 * decrypted[0x7e] << 16; ncotp |= decrypted[0x7f] << 24;
		 */
