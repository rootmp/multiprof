...
public class AdminMonsterRace implements IAdminCommandHandler
{
	...
	private void handleSendPacket(Player activeChar)
	{
		...
		else if (state == 0)
		{
			...
			// TODO исправить 121209259 - обжект айди, ток неизвестно какого обьекта
			// (VISTALL)
	...
	class RunRace implements Runnable
	{
		...
		public void run()
		{
			...
			/*
			 * int[] speed = new int[8]; for(int i=0; i<8; i++) { for(int j=0; j<20; j++) {
			 * //_log.info.println("Adding "+speeds1[i][j] +" and "+ speeds2[i][j]);
