		...
		if(activeChar.getPlayerAccess().Menu)
		{
			...
			switch(command)
			{
				...
				case admin_balthus_event:
					...
					try
					{
						round = Integer.parseInt(wordList[1]);
						stage = Integer.parseInt(wordList[2]);
						jackpotId = Integer.parseInt(wordList[3]);
						coinsCount = Integer.parseInt(wordList[4]);
						receivedAmount = Integer.parseInt(wordList[5]);
						isParticipate = Boolean.parseBoolean(wordList[6]);
						isAwarded = Boolean.parseBoolean(wordList[7]);
