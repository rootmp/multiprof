...
public class ResidenceFunctionTemplate implements Comparable<ResidenceFunctionTemplate>
{
	...
	private double _hpRegen = 0; // Percents = (100 * _hpRegen) - 100
	private double _mpRegen = 0; // Percents = (100 * _mpRegen) - 100
	private double _expRestore = 0; // Percents = (100 * _expRestore)
