...
public class PkRankerData
{
	...
	public PkRankerData(int nCharId, String sUserName, String sPledgeName, int nLevel, int nClassId, int nRace, int nClassRank, int nRaceRank, int nServerRank)
	{
	...
	public PkRankerData(Player player)
	{
