...
{
	private final int _minFarmTime, _maxFarmTime;
	...
	public static GoToTownActions parse(FakePlayerActionsHolder actionsHolder, Element element)
	{
		...
		int minFarmTime = element.attributeValue("farm_time")
				!= null ? Integer.parseInt(element.attributeValue("farm_time")) : Integer.parseInt(element.attributeValue("min_farm_time"));
