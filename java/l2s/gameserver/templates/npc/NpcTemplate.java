...
public class NpcTemplate extends CreatureTemplate
{
	...
	public final int rewardElementalExp;
	...
	public NpcTemplate(StatsSet set)
	{
		...
		rewardElementalExp = set.getInteger("rewardElementalExp", 0);
	...
	{
		String name = NpcNameHolder.getInstance().getNpcName(player, getId());
