...
public class ChatUtils
{
	...
	public static void shout(Player activeChar, IBroadcastPacket cs)
	{
		shout(activeChar, cs, null);
	}
	...
	public static void announce(Player activeChar, IBroadcastPacket cs)
	{
		announce(activeChar, cs, null);
	}
	...
	{
		player.sendPacket(new SayPacket2(0, ChatType.SYSTEM, 0, title, text));
	}
