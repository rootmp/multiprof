...
public class ItemsDAO implements JdbcDAO<Integer, ItemInstance>
{
	...
	private final static String RESTORE_ITEM = "SELECT object_id, owner_id, item_id, count, enchant_level, loc, loc_data, custom_type1, custom_type2, life_time, custom_flags, variation_stone_id, variation1_id, variation2_id, agathion_energy, appearance_stone_id, visual_id, isBlessed FROM items WHERE object_id = ?";
	private final static String RESTORE_OWNER_ITEMS = "SELECT object_id FROM items WHERE owner_id = ? AND loc = ?";
	private final static String STORE_ITEM = "INSERT INTO items (object_id, owner_id, item_id, count, enchant_level, loc, loc_data, custom_type1, custom_type2, life_time, custom_flags, variation_stone_id, variation1_id, variation2_id, agathion_energy, appearance_stone_id, visual_id, isBlessed) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	private final static String UPDATE_ITEM = "UPDATE items SET owner_id = ?, item_id = ?, count = ?, enchant_level = ?, loc = ?, loc_data = ?, custom_type1 = ?, custom_type2 = ?, life_time = ?, custom_flags = ?, variation_stone_id = ?, variation1_id = ?, variation2_id = ?, agathion_energy=?, appearance_stone_id=?, visual_id=?, isBlessed=? WHERE object_id = ?";
	...
	private void update0(ItemInstance item, PreparedStatement statement) throws SQLException
	{
		...
		statement.setBoolean(17, item.isBlessed());
