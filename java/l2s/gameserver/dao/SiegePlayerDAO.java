...
public class SiegePlayerDAO
{
	...
	public static final String DELETE_SQL_QUERY2 = "DELETE FROM siege_players WHERE residence_id=? AND clan_id=?";
	public static final String DELETE_SQL_QUERY3 = "DELETE FROM siege_players WHERE residence_id=?";
	...
	public void delete(Residence residence, int clanId)
	{
		Connection con = null;
		PreparedStatement statement = null;
		try
	...
	public void delete(Residence residence)
	{
		...
		{
			con = DatabaseFactory.getInstance().getConnection();
			statement = con.prepareStatement(DELETE_SQL_QUERY3);
			statement.setInt(1, residence.getId());
			statement.execute();
		}
		catch(Exception e)
