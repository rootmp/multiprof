...
public class CastleDAO
{
	...
	public static final String SELECT_SQL_QUERY = "SELECT tax, treasury, siege_date, last_siege_date, owner_id, own_date, side FROM castle WHERE id=? LIMIT 1";
	public static final String REPLACE_SQL_QUERY = "REPLACE INTO castle (id, name, tax, treasury, last_siege_date, owner_id, own_date, siege_date, side) VALUES (?,?,?,?,?,?,?,?,?)";
	...
	private void update0(Castle castle)
	{
		...
		try
		{
			...
			statement.setInt(++i, castle.getTaxPercent());
