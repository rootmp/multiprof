...
public class VillageMasterPledgeBypasses
{
	...
	protected static void dissolveClan(NpcInstance npc, Player player)
	{
		...
		for(Residence r : ResidenceHolder.getInstance().getResidences())
		{
			...
			if(siegeEvent.getSiegeClan(SiegeEvent.ATTACKERS, clan) != null || siegeEvent.getSiegeClan(SiegeEvent.DEFENDERS, clan) != null
					|| siegeEvent.getSiegeClan(CastleSiegeEvent.DEFENDERS_WAITING, clan) != null)
			{
