...
public class BossInstance extends RaidBossInstance
{
	...
	{
		return Config.RATE_DROP_ITEMS_BOSS; // ПА не увеличивает дроп с боссов
	}

	@Override
	public double getDropChanceMod(Player player)
	{
		return Config.DROP_CHANCE_MODIFIER_BOSS; // ПА не увеличивает дроп с боссов
	}

	@Override
	public double getDropCountMod(Player player)
	{
		return Config.DROP_COUNT_MODIFIER_BOSS; // ПА не увеличивает дроп с боссов
	}
