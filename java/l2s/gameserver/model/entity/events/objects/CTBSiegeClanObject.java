...
public class CTBSiegeClanObject extends SiegeClanObject
{
	...
	public CTBSiegeClanObject(ClanHallTeamBattleEvent siegeEvent, String type, Clan clan, long param, long date)
	{
		super(siegeEvent, type, clan, param, date);
		_npcId = param;
	}

	public CTBSiegeClanObject(ClanHallTeamBattleEvent siegeEvent, String type, Clan clan, long param)
	{
