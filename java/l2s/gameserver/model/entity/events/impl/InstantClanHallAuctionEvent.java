...
public class InstantClanHallAuctionEvent extends SiegeEvent<InstantClanHall, SiegeClanObject>
{
	...
	public void reCalcNextTime(boolean onStart)
	{
		...
		addOnTimeAction((int) ((_endAuctionDate.getTimeInMillis() - siegeDate.getTimeInMillis()) / 1000), new StartStopAction(EVENT, false));
	...
	public void startEvent()
	{
		...
		// TODO: Должно ли быть какое-то глобальное сообщение?
	}
