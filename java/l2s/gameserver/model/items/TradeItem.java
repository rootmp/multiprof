...
/**
 * Абстрактное описание предмета, безопасное для любых операций. Может
 * использоваться как ссылка на уже существующий предмет либо как набор
 * информации для создания нового.
 */
public final class TradeItem extends ItemInfo
{
	...
	/**
	 * Устанавливает время респауна предмета, используется в NPC магазинах с
	...
	/**
	 * Возвращает время респауна предмета, используется в NPC магазинах с
	 * ограниченным количеством.
	 * 
	...
	/**
	 * Возвращает ограничен ли этот предмет в количестве, используется в NPC
	 * магазинах с ограниченным количеством.
	 * 
	...
	/**
	 * Устанавливает время последнего респауна предмета, используется в NPC
	 * магазинах с ограниченным количеством.
	 * 
	...
	/**
	 * Возвращает время последнего респауна предмета, используется в NPC магазинах с
	 * ограниченным количеством.
	 * 
	 * @return unixtime в минутах
	 */
