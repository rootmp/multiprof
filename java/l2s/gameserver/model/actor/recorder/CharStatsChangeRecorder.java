...
public class CharStatsChangeRecorder<T extends Creature>
{
	...
	public static final int FORCE_BROADCAST_CHAR_INFO = 1 << 5;
	...
	protected int _maxCp;
	protected int _maxDp;
	protected int _maxBp;
	...
	protected void refreshStats()
	{
		...
		_maxDp = set(SEND_STATUS_INFO, _maxDp, _activeChar.getMaxDp());
		_maxBp = set(SEND_STATUS_INFO, _maxBp, _activeChar.getMaxBp());
		...
		_collisionRadius = set(FORCE_BROADCAST_CHAR_INFO, _collisionRadius, _activeChar.getCurrentCollisionRadius());
		_collisionHeight = set(FORCE_BROADCAST_CHAR_INFO, _collisionHeight, _activeChar.getCurrentCollisionHeight());
