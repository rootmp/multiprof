...
public class RequestExRequestLockedItem implements IClientIncomingPacket
{
	...
	public void run(GameClient client)
	{
		...
		if(!item.getTemplate().possiblyLock())
			return;
		
		if(ItemFunctions.deleteItem(player, 48400, 1, "ExRequestLockedItem"))
		{
			item.setLocked(true);
			...
			player.sendPacket(new ExLockedResult(1,1));
		}*/
	}
}