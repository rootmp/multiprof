...
public class RequestFriendAddReply implements IClientIncomingPacket
{
	...
	public void run(GameClient client)
	{
		...
		try
		{
			...
			requestor.sendPacket(SystemMsg.THAT_PERSON_HAS_BEEN_SUCCESSFULLY_ADDED_TO_YOUR_FRIEND_LIST, new SystemMessagePacket(SystemMsg.S1_HAS_JOINED_AS_A_FRIEND).addName(activeChar), new L2FriendListPacket(requestor));
