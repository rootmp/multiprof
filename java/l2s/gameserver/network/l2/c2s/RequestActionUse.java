...
public class RequestActionUse implements IClientIncomingPacket
{
	...
	/*
	 * type: 0 - action 1 - pet action 2 - summon action 3 - social 4 - couple
	 * social 5 - one more summons actions
	 */
	public static enum Action
	{
		...
		ACTION1015(1015, 2, 50094), // Отчаяние Тени
		...
		ACTION1085(1085, 2, 4707), // Жертва Тени
