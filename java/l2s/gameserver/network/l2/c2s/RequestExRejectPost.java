...
/**
 * Шлется клиентом как запрос на отказ принять письмо из
 * {@link ExReplyReceivedPost}. Если к письму приложены вещи то их надо вернуть
 * отправителю.
 */
public class RequestExRejectPost implements IClientIncomingPacket
{
	private int postId;
	...
	public void run(GameClient client)
	{
		...
		if (mail != null)
		{
			...
			int expireTime = 360 * 3600 + (int) (System.currentTimeMillis() / 1000L); // TODO [G1ta0] хардкод времени
																						// актуальности почты
