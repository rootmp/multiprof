...
public class SystemMessage implements IClientOutgoingPacket
{
	...
	// Message: Your level cannot purchase this item.
	...
	public static final int OBTAINED_S1S_CLAN_XP = 13312;
	...
	public static final int YOU_CANNOT_USE_THIS_FEATURE_WHILE_TELEPORTING = 7390;
	...
	public SystemMessage addPlayerName(String text)
	{
	 ...
	 */
	public SystemMessage addName(Creature cha, Creature receiver)
	{
		if(cha == null)
		...
		if(cha.isNpc())
		{
			...
			if((npc.getNpcId() != npc.getTemplate().displayId && npc.getTemplate().displayId != 0))
				return addNpcName(npc.getTemplate().displayId);
	...
	{
		args.add(new Arg(TYPE_DOOR_NAME, Integer.valueOf(id)));
		return this;
	}

	public SystemMessage addNpcName(int id)
	{
		args.add(new Arg(TYPE_NPC_NAME, Integer.valueOf(1000000 + id)));
		return this;
	}
	...
	public ByteBuf getOpcodes()
	{
		try
		{
			ServerPacketOpcodes spo = ServerPacketOpcodes507.SystemMessagePacket;
