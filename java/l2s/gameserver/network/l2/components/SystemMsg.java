...
{
	// Message: A letter from the Fortress Manager arrived.
	...
	THE_FORTRESS_BATTLE_HAS_BEGUN(13148),
	// Message: $s1 has captured the flag!
	S1_HAS_CAPTURED_THE_FLAG(13149),
	// Message: A flag can be captured only by a clan member of Lv. 5 or higher.
	A_FLAG_CAN_BE_CAPTURED_ONLY_BY_A_CLAN_MEMBER_OF_LV_5_OR_HIGHER(13150),
	// Message: $s1 displayed the flag successfully!
	S1_DISPLAYED_THE_FLAG_SUCCESSFULLY(13151),
	// Message: The fortress battle will be over in $s1 min.
	THE_FORTRESS_BATTLE_WILL_BE_OVER_IN_S1_MIN(13152),
	// Message: The fortress battle is over.
	THE_FORTRESS_BATTLE_IS_OVER(13153),
	// Message: You can use that only in a fortress battle.
	YOU_CAN_USE_THAT_ONLY_IN_A_FORTRESS_BATTLE(13154),
	// Message: $s1 is trying to display the flag.
	S1_IS_TRYING_TO_DISPLAY_THE_FLAG(13155),
	// Message: A clan that owns a castle cannot display a flag.
	A_CLAN_THAT_OWNS_A_CASTLE_CANNOT_DISPLAY_A_FLAG(13158),
	// Message: A clan that owns a castle cannot get a flag.
	A_CLAN_THAT_OWNS_A_CASTLE_CANNOT_GET_A_FLAG_(13159),
	// Message: A clan that owns a castle cannot put a seal.
	A_CLAN_THAT_OWNS_A_CASTLE_CANNOT_PUT_A_SEAL(13160),
	// Message: You cannot cancel the siege when you are recruiting mercenaries.
	YOU_CANNOT_CANCEL_THE_SIEGE_WHEN_YOU_ARE_RECRUITING_MERCENARIES(13113),
	// Message: The character is not a mercenary anymore, because his/ her clan
	// takes part in the Siege.
	THE_CHARACTER_IS_NOT_A_MERCENARY_ANYMORE_BECAUSE_HIS_HER_CLAN_TAKES_PART_IN_THE_SIEGE_(13068),
	// Message: Attackers and defenders cannot be recruited as mercenaries.
	ATTACKERS_AND_DEFENDERS_CANNOT_BE_RECRUITED_AS_MERCENARIES(13042),
	// Message: You cannot file a mercenary request to a clan, which has not receive
	// the right to defend the Castle.
	YOU_CANNOT_FILE_A_MERCENARY_REQUEST_TO_A_CLAN_WHICH_HAS_NOT_RECEIVE_THE_RIGHT_TO_DEFEND_THE_CASTLE(13062),
	// Message: This clan does not hire mercenaries at the time.
	THIS_CLAN_DOES_NOT_HIRE_MERCENARIES_AT_THE_TIME(13040),
	// Message: Mercenary application/application cancellation is being processed.
	// Try again after the process ends.
	MERCENARY_APPLICATIONAPPLICATION_CANCELLATION_IS_BEING_PROCESSED_TRY_AGAIN_AFTER_THE_PROCESS_ENDS(13034),
	// Message: Exceeded the maximum number of mercenaries. You cannot apply.
	EXCEEDED_THE_MAXIMUM_NUMBER_OF_MERCENARIES_YOU_CANNOT_APPLY(13063),
	// Message: Your character does not meet the level requirements to be a
	// mercenary.
	YOUR_CHARACTER_DOES_NOT_MEET_THE_LEVEL_REQUIREMENTS_TO_BE_A_MERCENARY(13044),
	// Message: A character, which is a member of a party, cannot file a mercenary
	// request.
	A_CHARACTER_WHICH_IS_A_MEMBER_OF_A_PARTY_CANNOT_FILE_A_MERCENARY_REQUEST(13045),
	// Message: One of the characters on your account is a mercenary. Only one
	// character can be a mercenary.
	ONE_OF_THE_CHARACTERS_ON_YOUR_ACCOUNT_IS_A_MERCENARY_ONLY_ONE_CHARACTER_CAN_BE_A_MERCENARY(13046),
	// Message: You cannot cancel the mercenary status when you belong to a party.
	YOU_CANNOT_CANCEL_THE_MERCENARY_STATUS_WHEN_YOU_BELONG_TO_A_PARTY(13048),
	// Message: The character is participating as a mercenary.
	THE_CHARACTER_IS_PARTICIPATING_AS_A_MERCENARY(13043),
	// Message: You cannot apply for mercenary after the castle siege starts.
	YOU_CANNOT_APPLY_FOR_MERCENARY_AFTER_THE_CASTLE_SIEGE_STARTS(13025),
	// Message: You cannot be a mercenary at the clan you are a member of.
	YOU_CANNOT_BE_A_MERCENARY_AT_THE_CLAN_YOU_ARE_A_MEMBER_OF(13041),
	// Message: You cannot hire mercenaries from a clan, which has announced or
	// started a war or declared a cease-fire.
	YOU_CANNOT_HIRE_MERCENARIES_FROM_A_CLAN_WHICH_HAS_ANNOUNCED_OR_STARTED_A_WAR_OR_DECLARED_A_CEASEFIRE_(13026),
	// Message: Already recruiting mercenaries.
	ALREADY_RECRUITING_MERCENARIES(13038),
	// Message: There is a mercenary applicant. You can’t cancel now.
	THERE_IS_A_MERCENARY_APPLICANT_YOU_CANT_CANCEL_NOW(13024),
	// Message: It is not a mercenary recruitment period.
	IT_IS_NOT_A_MERCENARY_RECRUITMENT_PERIOD(13036),
	// Message: The siege is under way. Try again after it is over.
	THE_SIEGE_IS_UNDER_WAY_TRY_AGAIN_AFTER_IT_IS_OVER_(13035),
	// Message: If a clan has not received the right to defend the Castle, it cannot
	// hire mercenaries.
	IF_A_CLAN_HAS_NOT_RECEIVED_THE_RIGHT_TO_DEFEND_THE_CASTLE_IT_CANNOT_HIRE_MERCENARIES(13061),
	// Message: You cannot use Forced Attack on the members and mercenaries of your
	// own clan.
	YOU_CANNOT_USE_FORCED_ATTACK_ON_THE_MEMBERS_AND_MERCENARIES_OF_YOUR_OWN_CLAN(13031),
	// Message: It is possible to forcibly attack other characters and mercenaries
	// from other clan, even if it's an ally clan.
	IT_IS_POSSIBLE_TO_FORCIBLY_ATTACK_OTHER_CHARACTERS_AND_MERCENARIES_FROM_OTHER_CLAN_EVEN_IF_ITS_AN_ALLY_CLAN(13030),
	// Message: The $s1 siege has started.
	THE_S1_SIEGE_HAS_STARTED(13021),
	...
	// match.
	UNABLE_TO_OPEN_OLYMPIAD_SCREEN_WHILE_IN_PARTICIPATING_OR_WATCHING_A_MATCH(5182),
	// Message: The server will be coming down in $s1 second(s). Please find a safe
	// place to log out.
	...
	// Message: You have moved too far away from the warehouse to perform that
	// action.
	...
	INCORRECT_NAME(204),
	// Message: The size of the image file is inappropriate. Please adjust to 16x12
	// pixels.
	...
	// Message: A clan war with Clan $s1 has started. The clan that cancels the war
	// first will lose 5,000 Clan Reputation. Any clan that cancels the war will be
	// unable to declare a war for 1 week. If your clan member gets killed by the
	// other clan, XP decreases by 1/4 of the amount that decreases in the hunting
	// ground.
	...
	// Message: The mentoring relationship with $s1 has been canceled. The mentor
	// cannot obtain another mentee for one week
	...
	// Message: The mentee $s1 reached level 86, so the mentoring relationship was
	// ended. After the mentee's graduation, the mentor cannot obtain another mentee
	// for 5 days.
	...
	// Message: As you are currently schedule for clan dissolution, no alliance can
	// be created.
	AS_YOU_ARE_CURRENTLY_SCHEDULE_FOR_CLAN_DISSOLUTION_NO_ALLIANCE_CAN_BE_CREATED(550),
	// Message: As you are currently schedule for clan dissolution, your clan level
	// cannot be increased.
	AS_YOU_ARE_CURRENTLY_SCHEDULE_FOR_CLAN_DISSOLUTION_YOUR_CLAN_LEVEL_CANNOT_BE_INCREASED(551),
	// Message: As you are currently schedule for clan dissolution, you cannot
	// register or delete a Clan Crest.
	...
	// Message: As your pet is currently out, its summoning item cannot be
	// destroyed.
	...
	// Message: Your pet is dead and any attempt you make to give it something goes
	// unrecognized.
	...
	// Message: The Friend's List of the person you are trying to add is full, so
	...
	// Message: Your bid price must be higher than the minimum price currently being
	// bid.
	...
	// Message: Castle-owning clans are automatically registered on the defending
	// side.
	...
	// Message: You cannot register as an attacker because you are in an alliance
	// with the castle-owning clan.
	...
	// Message: $c1 cannot join the clan because one day has not yet passed since
	// they left another clan.
	...
	// since they left another alliance.
	S1_CLAN_CANNOT_JOIN_THE_ALLIANCE_BECAUSE_ONE_DAY_HAS_NOT_YET_PASSED_SINCE_THEY_LEFT_ANOTHER_ALLIANCE(761),
	// Message: The clan hall which was put up for auction has been awarded to $s1
	// clan.
	...
	// Message: You do not have enough funds in the clan warehouse for the Manor to
	// operate.
	...
	// Message: Payment for your clan hall has not been made. Please make payment to
	// your clan warehouse by $s1 tomorrow.
	...
	// Message: The temporary alliance of the Castle Attacker team is in effect. It
	...
	// Message: You are not allowed to chat with a contact while a chatting block is
	// imposed.
	...
	// Message: The list of party rooms can only be viewed by a person who is not
	// part of a party.
	...
	// Message: You have been registered for the Grand Olympiad waiting list for a
	// class specific match.
	...
	// Message: $c1 is making an attempt to resurrect you. If you choose this path,
	// $s2 experience points will be returned to you. Do you want to be resurrected?
	C1_IS_MAKING_AN_ATTEMPT_TO_RESURRECT_YOU_IF_YOU_CHOOSE_THIS_PATH_S2_EXPERIENCE_WILL_BE_RETURNED_FOR_YOU(1510),
	// Message: While a pet is being resurrected, it cannot help in resurrecting its
	// master.
	...
	// Message: The pet has been killed. If you don't resurrect it within 24 hours,
	...
	// Message: $s1 has declared a Clan War. The war will automatically start if you
	// kill $s1 clan members 5 times within a week.
	...
	// Message: War has already been declared against that clan… but I'll make note
	...
	// that owns a clan hall or castle can display a crest.
	...
	// Message: Only the creator of a command channel can use the channel dismiss
	// command.
	...
	// Message: $c1 does not meet the participation requirements as the inventory
	// weight / slot is filled beyond 80%%.
	C1_DOES_NOT_MEET_THE_PARTICIPATION_REQUIREMENTS_AS_THE_INVENTORY_WEIGHT__SLOT_IS_FILLED_BEYOND_80(1691),
	...
	// Message: In $s1 minute(s), the game will begin. All players, please enter the
	// arena now.
	...
	// Message: $c1 does not meet the conditions of the party room. Please update
	// the waiting list.
	...
	// Message: This serial number cannot be entered. Please try again in $s1
	// minute(s).
	...
	// Message: $c1 is currently trading or operating a private store and cannot be
	// summoned.
	...
	// Message: $c1 has accepted your challenge to a duel. The duel will begin in a
	// few moments.
	C1_HAS_ACCEPTED_YOUR_CHALLENGE_TO_A_DUEL(1929),
	// Message: You have accepted $c1's challenge a duel. The duel will begin in a
	// few moments.
	...
	// Message: $c1 cannot duel because $c1 is currently engaged in a private store
	// or manufacture.
	...
	// Message: $c1 cannot duel because $c1 is currently riding a boat, steed, or
	// strider.
	...
	// Message: A sub-class cannot be created or changed because you have exceeded
	// your inventory limit.
	A_SUBCLASS_CANNOT_BE_CREATED_OR_CHANGED_BECAUSE_YOU_HAVE_EXCEEDED_YOUR_INVENTORY_LIMIT(2033),
	// Message: Some Lineage II features have been limited for free trials. Trial
	// accounts aren’t allowed to trade items and/or Adena. To unlock all of the
	// features of Lineage II, purchase the full version today.
	SOME_LINEAGE_II_FEATURES_HAVE_BEEN_LIMITED_FOR_FREE_TRIALS_(2039),
	// Message: Some Lineage II features have been limited for free trials. Trial
	// accounts aren’t allowed buy items from private stores. To unlock all of the
	// features of Lineage II, purchase the full version today.
	...
	// skill $s1 has been decreased by 1.
	...
	// Message: Shout and trade chatting cannot be used while possessing a cursed
	// weapon.
	SHOUT_AND_TRADE_CHATTING_CANNOT_BE_USED_WHILE_POSSESSING_A_CURSED_WEAPON(2085),
	// Message: Search on user $c2 for third-party program use will be completed in
	// $s1 minute(s).
	...
	// Message: $c1 is in a location which cannot be entered, therefore it cannot be
	// processed.
	...
	// Message: The maximum number of instance zones has been exceeded. You cannot
	// enter.
	THE_MAXIMUM_NUMBER_OF_INSTANCE_ZONES_HAS_BEEN_EXCEEDED(2104),
	// Message: You have entered another instance zone, therefore you cannot enter
	// corresponding dungeon.
	YOU_HAVE_ENTERED_ANOTHER_INSTANCE_ZONE_THEREFORE_YOU_CANNOT_ENTER_CORRESPONDING_DUNGEON(2105),
	// Message: This dungeon will expire in $s1 minute(s). You will be forced out of
	// the dungeon when the time expires.
	...
	// be found in your personal warehouse.
	YOU_HAVE_BID_THE_HIGHEST_PRICE_AND_HAVE_WON_THE_ITEM(2131),
	// Message: You cannot add elemental power while operating a Private Store or
	// Private Workshop.
	...
	// Message: Another elemental power has already been added. This elemental power
	// cannot be added.
	...
	// Message: Force attack is impossible against a temporary allied member during
	// a siege.
	...
	// Message: The ballista has been successfully destroyed. The clan's reputation
	// will be increased.
	...
	// Message: It is not possible to register for the castle siege side or castle
	// siege of a higher castle in the contract.
	...
	// Message: You are participating in the siege of $s1. This siege is scheduled
	// for 2 hours.
	...
	// Message: Your pet's hunger gauge is below 10%. If your pet isn't fed soon, it
	// may run away.
	...
	// Message: This skill cannot be learned while in the sub-class state. Please
	// try again after changing to the main class.
	...
	// Message: $c1 inflicted $s3 damage on $c2 and $s4 damage on the damage
	// transfer target.
	...
	// Message: There are $s2 hour(s), $s3 minute(s), and $s4 second(s) remaining in
	// $s1's re-use time.
	THERE_ARE_S2_HOURS_S3_MINUTES_AND_S4_SECONDS_REMAINING_IN_S1S_REUSE_TIME(2305),
	// Message: Your Charm of Courage is trying to resurrect you. Would you like to
	// resurrect now?
	...
	// Message: You cannot use My Teleports while you are in a petrified or
	// paralyzed state.
	...
	// Message: $s1 has expired.
	S1_HAS_EXPIRED(2364),
	// Message: The limited-time item has disappeared because the remaining time ran
	// out.
	...
	// Message: You cannot report a character who is in a peace zone or a
	// battleground.
	...
	// Message: You cannot report a character who has not acquired any XP after
	// connecting.
	...
	// Message: You have reached the maximum number of My Teleport slots or use
	// conditions are not observed.
	YOU_HAVE_REACHED_THE_MAXIMUM_NUMBER_OF_MY_TELEPORT_SLOTS_OR_USE_CONDITIONS_ARE_NOT_OBSERVED(2390),
	...
	// Message: Clan lord $c2, who leads clan $s1, has been declared the lord of the
	// $s3 territory.
	...
	// Message: $c1 is already registered on the waiting list for the 3 vs. 3 class
	...
	// Message: The request cannot be made because the requirements have not been
	// met. To participate in a team match, you must first form a 3-member party.
	...
	// Message: Your cloak has been unequipped because your armor set is no longer
	// complete.
	...
	// Message: In order to acquire an airship, the clan's level must be level 5 or
	// higher.
	...
	// Message: You have used a report point on $c1. You have $s2 points remaining
	// on this account.
	YOU_HAVE_USED_A_REPORT_POINT_ON_C1_YOU_HAVE_S2_POINTS_REMAINING_ON_THIS_ACCOUNT(2468),
	// Message: You have used all available points. Points are reset everyday at
	// noon.
	...
	// Message: You have been reported as an illegal program user, so your party
	// participation will be blocked for 60 minutes.
	YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_SO_YOUR_PARTY_PARTICIPATION_WILL_BE_BLOCKED_FOR_60_MINUTES(2474),
	// Message: You have been reported as an illegal program user, so your actions
	// will be restricted for 120 minutes.
	YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_SO_YOUR_ACTIONS_WILL_BE_RESTRICTED_FOR_120_MINUTES(2477),
	// Message: You have been reported as an illegal program user, so your actions
	// will be restricted for 180 minutes.
	...
	// Message: $c1 has been reported as an illegal program user and cannot join a
	// party.
	C1_HAS_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_CANNOT_JOIN_A_PARTY(2482),
	// Message: You have been reported as an illegal program user, so participating
	// in a party is not allowed.
	YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_SO_PARTICIPATING_IN_A_PARTY_IS_NOT_ALLOWED(2484),
	// Message: Your ship cannot teleport because it does not have enough fuel for
	// the trip.
	...
	// Message: Applicants for the Olympiad, Underground Coliseum, or Kratei's Cube
	...
	// Message: You have been reported as an illegal program user and cannot report
	// other users.
	...
	// Message: You can make another report in $s1-minute(s). You have $s2 point(s)
	...
	// Message: You must have a minimum of ($s1) people to enter this Instant Zone.
	...
	// Message: The clan who owns the territory cannot participate in the territory
	// war as mercenaries.
	THE_CLAN_WHO_OWNS_THE_TERRITORY_CANNOT_PARTICIPATE_IN_THE_TERRITORY_WAR_AS_MERCENARIES(2796),
	// Message: It is not a territory war registration period, so a request cannot
	...
	// Message: This clan member cannot withdraw or be expelled while participating
	// in a territory war.
	...
	// Message: The item that you're trying to send cannot be forwarded because it
	// isn't proper.
	...
	// Message: You cannot enter the Command Channel matching room because you do
	...
	// Message: The Command Channel affiliated party's party member cannot use the
	// matching screen.
	...
	// Message: When the recipient doesn't exist or the character has been deleted,
	...
	// Message: I can feel that the energy being flown in the Kasha's eye is getting
	// stronger rapidly.
	...
	// Message: A user currently participating in the Olympiad cannot send party and
	// friend invitations.
	...
	// Message: The size of the uploaded symbol does not meet the standard
	// requirements.
	...
	// Message: $c1 is in a chaotic state and cannot be requested for a couple
	// action.
	...
	// Message: Your pet is starving and will not obey until it gets it's food. Feed
	// your pet!
	...
	// Message: There are $s2 minutes $s3 seconds remaining for $s1's re-use time.
	// It is reset every day at 6:30 AM.
	...
	// Message: $c1 is set to refuse couple actions and cannot be requested for a
	// couple action.
	...
	// Message: You can proceed only when the inventory weight is below 80 percent
	// and the quantity is below 90 percent.
	...
	// Message: Nevit's Advent Blessing shines strongly from above. You can almost
	// see his divine aura.
	...
	// Message: You cannot declare defeat as it has not been 7 days since starting a
	// clan war with Clan $s1.
	...
	// Message: The war ended by the $s1 clan's Defeat Declaration. You have won the
	// Clan War over the $s1 clan.
	THE_WAR_ENDED_BY_THE_S1_CLANS_DEFEAT_DECLARATION_YOU_HAVE_WON_THE_CLAN_WAR_OVER_THE_S1_CLAN(3285),
	// Message: You can't declare a war because the 21-day-period hasn't passed
	// after a Defeat Declaration with the $s1 clan.
	YOU_CANT_DECLARE_A_WAR_BECAUSE_THE_21DAYPERIOD_HASNT_PASSED_AFTER_A_DEFEAT_DECLARATION_WITH_THE_S1_CLAN(3286),
	// Message: This account has already received a gift. The gift can only be given
	// once per account.
	THIS_ACCOUNT_HAS_ALREADY_RECEIVED_A_GIFT_THE_GIFT_CAN_ONLY_BE_GIVEN_ONCE_PER_ACCOUNT(3289),
	// Message: The number of graduates of the Clan Academy is $s1. $s2 bonus points
	// have been added to your Clan Reputation.
	...
	// Message: Registration is not available because the corresponding item does
	// not exist.
	...
	// Message: Item Purchase is not available because the corresponding item does
	// not exist.
	...
	// Message: $s1 already graduated from a Clan Academy, therefore re-joining is
	// not allowed.
	...
	// Message: You must have rights to a Clan Hall auction in order to make a bid
	// for Provisional Clan Hall.
	...
	// Message: The auction house registration period has expired and the
	// corresponding item is being forwarded.
	THE_AUCTION_HOUSE_REGISTRATION_PERIOD_HAS_EXPIRED_AND_THE_CORRESPONDING_ITEM_IS_BEING_FORWARDED(3493),
	// Message: You cannot receive a symbol because you are below the required
	// level.
	...
	// Message: You cannot receive a symbol because you don't meet the class
	// requirements.
	YOU_CANNOT_RECEIVE_A_SYMBOL_BECAUSE_YOU_DONT_MEET_THE_CLASS_REQUIREMENTS(3501),
	// Message: A replacement player for $c1 has been found, and an invitation is
	// sent.
	A_REPLACEMENT_PLAYER_FOR_C1_HAS_BEEN_FOUND_AND_AN_INVITATION_IS_SENT(3511),
	// Message: The player who was invited rejected the invitation. Please register
	// again.
	...
	// Message: You cannot register in the waiting list while participating in Block
	// Checker/Coliseum/Kratei's Cube.
	...
	// may be applied until the next cycle.
	...
	// Message: The corresponding work cannot be proceeded because the inventory
	...
	// Message: You can not change the attribute while operating a private store or
	// private workshop.
	...
	// Message: The character and item recipe levels do not match, so it cannot be
	// used normally.
	THE_CHARACTER_AND_ITEM_RECIPE_LEVELS_DO_NOT_MATCH_SO_IT_CANNOT_BE_USED_NORMALLY(3729),
	// Message: You are now on the waiting list. You will automatically be
	// teleported when the tournament starts, and will be removed from the waiting
	// list if you log out. If you cancel registration (within the last minute of
	// entering the arena after signing up) 30 times or more or forfeit after
	// entering the arena 30 times or more during a cycle, you become ineligible for
	// participation in the Ceremony of Chaos until the next cycle.
	...
	// Message: You cannot open a private store or workshop in the Ceremony of
	// Chaos.
	YOU_CANNOT_OPEN_A_PRIVATE_STORE_OR_WORKSHOP_IN_THE_CEREMONY_OF_CHAOS(3742),
	// Message: In $s1 second(s), you will be moved to where you were before
	// participating in the Ceremony of Chaos.
	...
	// Message: You cannot invite a friend or party while participating in the
	// Ceremony of Chaos.
	...
	// Message: Because $c1 was killed by a clan member of $s2, Clan Reputation
	// decreased by 1.
	BECAUSE_C1_WAS_KILLED_BY_A_CLAN_MEMBER_OF_S2_CLAN_REPUTATION_DECREASED_BY_1(3811),
	// Message: Because a clan member of $s1 was killed by $c2, Clan Reputation
	// increased by 1.
	BECAUSE_A_CLAN_MEMBER_OF_S1_WAS_KILLED_BY_C2_CLAN_REPUTATION_INCREASED_BY_1(3812),
	// Message: Because Clan $s1 did not fight back for 1 week, the clan war was
	// cancelled.
	...
	// Message: Only the clan leader or someone with rank management authority may
	// register the clan.
	ONLY_THE_CLAN_LEADER_OR_SOMEONE_WITH_RANK_MANAGEMENT_AUTHORITY_MAY_REGISTER_THE_CLAN(4031),
	// Message: You may apply for entry after $s1 minute(s) due to cancelling your
	// application.
	YOU_MAY_APPLY_FOR_ENTRY_AFTER_S1_MINUTES_DUE_TO_CANCELLING_YOUR_APPLICATION(4038),
	// Message: Entry application complete. Use "Entry Application Info" to check or
	// cancel your application. Application is automatically cancelled after 30
	// days; if you cancel application, you cannot apply again for 5 minutes.
	ENTRY_APPLICATION_COMPLETE_USE_ENTRY_APPLICATION_INFO_TO_CHECK_OR_CANCEL_YOUR_APPLICATION(4039),
	// Message: Entry application cancelled. You may apply to a new clan after 5
	// minutes.
	...
	// Message: Players can respond to a whisper, but cannot initiate a whisper
	// until Lv. $s1.
	PLAYERS_CAN_RESPOND_TO_A_WHISPER_BUT_CANNOT_INITIATE_A_WHISPER_UNTIL_LV_S1(4107),
	// Message: You cannot use the Beauty Shop while registered in the Ceremony of
	// Chaos.
	...
	// Message: You cannot proceed as you are not an alliance leader or party
	// leader.
	YOU_CANNOT_PROCEED_AS_YOU_ARE_NOT_AN_ALLIANCE_LEADER_OR_PARTY_LEADER(4155),
	...
	// Message: You have reached the maximum amount of Raid Points, and can acquire
	// no more.
	...
	// Message: Today you reached the limit of use of the world chat. Reset of the
	// world use the chat is done daily at 6:30 am.
	...
	// Message: You cannot use Alchemy while trading or using a private store or
	// shop.
	...
	// Message: You cannot use or reset Ability Points while participating in the
	// Olympiad or Ceremony of Chaos.
	YOU_CANNOT_USE_OR_RESET_ABILITY_POINTS_WHILE_PARTICIPATING_IN_THE_OLYMPIAD_OR_CEREMONY_OF_CHAOS(4296),
	// Message: You cannot change your subclass while registered in the Ceremony of
	// Chaos.
	...
	// Message: You can redeem your reward $s1 minutes after logging in. $s2 minutes
	// left.
	...
	// Message: The item was upgraded. You obtained $s1.
	THE_ITEM_WAS_UPGRADED_YOU_OBTAINED_S1(4471),
	// Message: $c1 has succeeded in upgrading equipment and obtained a $s2.
	C1_HAS_SUCCEEDED_IN_UPGRADING_EQUIPMENT_AND_OBTAINED_A_S2(4472),
	// Message: Failed the operation.
	FAILED_THE_OPERATION(4473),
	// Message: Failed because the target item does not exist.
	FAILED_BECAUSE_THE_TARGET_ITEM_DOES_NOT_EXIST(4474),
	// Message: Failed because there are not enough ingredients.
	FAILED_BECAUSE_THERE_ARE_NOT_ENOUGH_INGREDIENTS(4475),
	// Message: Failed because there's not enough Adena.
	FAILED_BECAUSE_THERES_NOT_ENOUGH_ADENA(4476),
	// Message: You cannot use the Agathion's power because you are not wearing the
	// left bracelet.
	...
	// Message: $s1 has delivered $s3 (Attribute Damage: $s5) to $s2, $s4 damage to
	// the damage transference target.
	S1_HAS_DELIVERED_S3_ATTRIBUTE_DAMAGE_S5_TO_S2_S4_DAMAGE_TO_THE_DAMAGE_TRANSFERENCE_TARGET(5178),
	// Message: You have obtained an Attribute. Open your Character Information
	// Screen to check.
	YOU_HAVE_OBTAINED_AN_ATTRIBUTE_OPEN_YOUR_CHARACTER_INFORMATION_SCREEN_TO_CHECK_(5181),
	// Message: You cannot use that in a non-peace zone location.
	YOU_CANNOT_USE_THAT_IN_A_NONPEACE_ZONE_LOCATION(5241),
	// Message: Macro use only.
	MACRO_USE_ONLY(5270),
	// Message: You've used up all your matches.
	YOUVE_USED_UP_ALL_YOUR_MATCHES(5297),
	// Message: $s1 was killed.
	S1_WAS_KILLED(5503),
	...
	// Message: The premium item for this account was provided. If the premium
	// account is terminated, this item will be deleted.
	THE_PREMIUM_ITEM_FOR_THIS_ACCOUNT_WAS_PROVIDED_IF_THE_PREMIUM_ACCOUNT_IS_TERMINATED_THIS_ITEM_WILL_BE_DELETED(6046),
	// Message: The premium item cannot be received because the inventory
	// weight/quantity limit has been exceeded.
	THE_PREMIUM_ITEM_CANNOT_BE_RECEIVED_BECAUSE_THE_INVENTORY_WEIGHTQUANTITY_LIMIT_HAS_BEEN_EXCEEDED(6047),
	// Message: The premium account has been terminated. The provided premium item
	// was deleted.
	THE_PREMIUM_ACCOUNT_HAS_BEEN_TERMINATED_THE_PROVIDED_PREMIUM_ITEM_WAS_DELETED(6048),
	// Message: Weapon Appearance Modification or Restoration is in progress. Please
	// try again after completing this task.
	...
	// Message: You cannot extract from items that are higher-grade than items to be
	// modified.
	...
	// Message: Congratulations! $c1 has obtained $s2 of $s3 through Fortune
	// Reading.
	CONGRATULATIONS_C1_HAS_OBTAINED_S2_OF_S3_THROUGH_FORTUNE_READING(6141),
	// Message: Congratulations! $c1 has obtained $s2 of $s3 in the Luxury Fortune
	// Reading.
	CONGRATULATIONS_C1_HAS_OBTAINED_S2_OF_S3_IN_THE_LUXURY_FORTUNE_READING(6142),
	// Message: You cannot receive rewards for training if you have trained for less
	// than 1 minute.
	...
	// Message: $c1 is currently in the Royal Training Camp, and cannot participate
	// in the Olympiad.
	C1_IS_CURRENTLY_IN_THE_ROYAL_TRAINING_CAMP_AND_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD(6162),
	// Message: You can only be rewarded as the class in which you entered the
	// training camp.
	...
	// Message: You cannot enter the training camp while in a party or using the
	...
	// Message: You cannot enter the training camp with a mount or in a transformed
	// state.
	...
	// Message: Your Day $s1 PC Café Attendance Reward is ready. Click on the
	// rewards icon.
	...
	// Message: The Attendance Reward cannot be received because the inventory
	// weight/quantity limit has been exceeded.
	...
	// Message: In $s1 min. you will be able to choose the collection effect again.
	IN_S1_MIN_YOU_WILL_BE_ABLE_TO_CHOOSE_THE_COLLECTION_EFFECT_AGAIN(6840),
	// Message: Collection effect has already been activated.
	COLLECTION_EFFECT_HAS_ALREADY_BEEN_ACTIVATED(6841),
	// Message: The collection is not full, you cannot activate the effect.
	THE_COLLECTION_IS_NOT_FULL_YOU_CANNOT_ACTIVATE_THE_EFFECT(6842),
	// Message: Unable to activate the effect due to system error. Try again later.
	UNABLE_TO_ACTIVATE_THE_EFFECT_DUE_TO_SYSTEM_ERROR_TRY_AGAIN_LATER(6843),
	// Message: Unable to continue due to system error. Try again later.
	UNABLE_TO_CONTINUE_DUE_TO_SYSTEM_ERROR_TRY_AGAIN_LATER(6844),
	// Message: List of transformations hasn't loaded. Try again later.
	LIST_OF_TRANSFORMATIONS_HASNT_LOADED_TRY_AGAIN_LATER(6845),
	// Message: Transformation, evolution, and extraction are not available during
	// private store or workshop use.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_DURING_PRIVATE_STORE_OR_WORKSHOP_USE(6846),
	// Message: Inappropriate item.
	INAPPROPRIATE_ITEM(6847),
	// Message: Not enough items.
	NOT_ENOUGH_ITEMS(6848),
	// Message: Transformation, evolution, and extraction are not available in the
	// freeze state.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_IN_THE_FREEZE_STATE(6849),
	// Message: Dead character cannot use transformation, evolution, and extraction.
	DEAD_CHARACTER_CANNOT_USE_TRANSFORMATION_EVOLUTION_AND_EXTRACTION(6850),
	// Message: Transformation, evolution, and extraction are not available during
	// exchange.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_DURING_EXCHANGE(6851),
	// Message: Transformation, evolution, and extraction are not available in the
	// petrification state.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_IN_THE_PETRIFICATION_STATE(6852),
	// Message: Transformation, evolution, and extraction are not available during
	// fishing.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_DURING_FISHING(6853),
	// Message: You cannot use transformation, evolution, and extraction while
	// sitting.
	YOU_CANNOT_USE_TRANSFORMATION_EVOLUTION_AND__EXTRACTION_WHILE_SITTING(6854),
	// Message: Evolution and extraction are not available during a fight.
	EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_DURING_A_FIGHT(6855),
	// Message: Evolution is not available for this transformation.
	EVOLUTION_IS_NOT_AVAILABLE_FOR_THIS_TRANSFORMATION(6856),
	// Message: Not enough material for evolution.
	NOT_ENOUGH_MATERIAL_FOR_EVOLUTION(6857),
	// Message: Transformation, evolution, and extraction are not available in a
	// fight.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_IN_A_FIGHT(6858),
	// Message: Extraction is not available for this transformation.
	EXTRACTION_IS_NOT_AVAILABLE_FOR_THIS_TRANSFORMATION(6859),
	// Message: Not enough materials for extraction.
	NOT_ENOUGH_MATERIALS_FOR_EXTRACTION(6860),
	// Message: Not enough space in inventory. Free some space and try again.
	NOT_ENOUGH_SPACE_IN_INVENTORY_FREE_SOME_SPACE_AND_TRY_AGAIN(6861),
	// Message: You cannot block or unblock a transformation during a fight.
	YOU_CANNOT_BLOCK_OR_UNBLOCK_A_TRANSFORMATION_DURING_A_FIGHT(6862),
	// Message: You cannor set and unblock your favorites during a fight.
	YOU_CANNOR_SET_AND_UNBLOCK_YOUR_FAVORITES_DURING_A_FIGHT(6863),
	// Message: In $s1 sec. you will be able to choose the collection effect again.
	IN_S1_SEC_YOU_WILL_BE_ABLE_TO_CHOOSE_THE_COLLECTION_EFFECT_AGAIN(6864),
	// Message: Transformation is not available at the moment. Try again later.
	TRANSFORMATION_IS_NOT_AVAILABLE_AT_THE_MOMENT_TRY_AGAIN_LATER(6865),
	// Message: Evolution of transformation is not available at the moment. Try
	// again later.
	EVOLUTION_OF_TRANSFORMATION_IS_NOT_AVAILABLE_AT_THE_MOMENT_TRY_AGAIN_LATER(6866),
	// Message: Transformation cannot be extracted at the moment. Try again later.
	TRANSFORMATION_CANNOT_BE_EXTRACTED_AT_THE_MOMENT_TRY_AGAIN_LATER(6867),
	// Message: Not enough L2 Coins.
	NOT_ENOUGH_L2_COINS(7113),
	// Message: You will exceed the max amount of time for the hunting zone, so you
	// cannot add any more time.
	YOU_WILL_EXCEED_THE_MAX_AMOUNT_OF_TIME_FOR_THE_HUNTING_ZONE_SO_YOU_CANNOT_ADD_ANY_MORE_TIME(13015),
	// Message: The time for hunting in this zone expires in $s1 min. Please add
	// more time.
	THE_TIME_FOR_HUNTING_IN_THIS_ZONE_EXPIRES_IN_S1_MIN_PLEASE_ADD_MORE_TIME(13016),
	// Message: Special instance zones cannot be used while waiting for the
	// Olympiad.
	SPECIAL_INSTANCE_ZONES_CANNOT_BE_USED_WHILE_WAITING_FOR_THE_OLYMPIAD(13019),
	// Message: To recruit mercenaries, clans must participate in the castle siege.
	TO_RECRUIT_MERCENARIES_CLANS_MUST_PARTICIPATE_IN_THE_CASTLE_SIEGE_(13037),
	// Message: You cannot apply for mercenary now.
	YOU_CANNOT_APPLY_FOR_MERCENARY_NOW(13039),
	// Message: Not enough money to use the function.
	NOT_ENOUGH_MONEY_TO_USE_THE_FUNCTION(13052),
	// Message: The character is in a location where it is impossible to use this
	// function.
	THE_CHARACTER_IS_IN_A_LOCATION_WHERE_IT_IS_IMPOSSIBLE_TO_USE_THIS_FUNCTION(13053),
	// Message: The character is in a location where it is impossible to use this
	// function.
	THE_CHARACTER_IS_IN_A_LOCATION_WHERE_IT_IS_IMPOSSIBLE_TO_USE_THIS_FUNCTION_2(13054),
	// Message: The target is no online. You can’t use this function.
	THE_TARGET_IS_NO_ONLINE_YOU_CANT_USE_THIS_FUNCTION(13056),
	// Message: Successful revenge on $c1!
	SUCCESSFUL_REVENGE_ON_C1(13057),
	// Message: $c1 took revenge on you!
	C1_TOOK_REVENGE_ON_YOU(13058),
	// Message: Not enough Monster Hunting count.
	NOT_ENOUGH_MONSTER_HUNTING_COUNT(13233),
	// Message: $c1 has defeated $c2.
	C1_HAS_DEFEATED_C2(13293),
	// Message: $c1 was attacked by $c2 and was killed.
	C1_WAS_ATTACKED_BY_C2_AND_WAS_KILLED(13294),
	// Message: Your pet has acquired $1 Skill.
	YOUR_PET_HAS_ACQUIRED_THE_S1_SKILL(13299),
	// Message: Ranker’s Authority cannot be used in this area.
	RANKERS_AUTHORITY_CANNOT_BE_USED_IN_THIS_AREA(13305),
	// Message: Server Rank 1 $c1 has created Ranker’s Authority in <$s2>.
	SERVER_RANK_1_C1_HAS_CREATED_RANKERS_AUTHORITY_IN_S2(13306),
	// Message: You can watch the siege turning on observation mode.
	YOU_CAN_WATCH_THE_SIEGE_TURNING_ON_OBSERVATION_MODE(13114),
	// Message: In $s1 sec. you will be taken to the Olympic Stadium for the 3 vs 3
	// competitions.
	IN_S1_SEC_YOU_WILL_BE_TAKEN_TO_THE_OLYMPIC_STADIUM_FOR_THE_3_VS_3_COMPETITIONS(13117),
	// Message: The $c1 team has won.
	THE_C1_TEAM_HAS_WON(13118),
	// Message: You've been registered for the 3 vs 3 Olympiad matches.
	YOUVE_BEEN_REGISTERED_FOR_THE_3_VS_3_OLYMPIAD_MATCHES(13119),
	// Message: The item cannot be equipped in the 3 vs 3 Olympiad.
	THE_ITEM_CANNOT_BE_EQUIPPED_IN_THE_3_VS_3_OLYMPIAD(13120),
	// Message: The item cannot be used in the 3 vs 3 Olympiad.
	THE_ITEM_CANNOT_BE_USED_IN_THE_3_VS_3_OLYMPIAD(13121),
	// Message: The skill cannot be used in the 3 vs 3 Olympiad.
	THE_SKILL_CANNOT_BE_USED_IN_THE_3_VS_3_OLYMPIAD(13122),
	// Message: The 3 vs 3 Olympiad has started.
	THE_3_VS_3_OLYMPIAD_HAS_STARTED(13123),
	// Message: The 3 vs 3 Olympiad has completed.
	THE_3_VS_3_OLYMPIAD_HAS_COMPLETED(13124),
	// Message: The 3 vs 3 Olympiad is not held right now.
	THE_3_VS_3_OLYMPIAD_IS_NOT_HELD_RIGHT_NOW(13125),
	// Message: The 3 vs 3 Olympiad registration is complete.
	THE_3_VS_3_OLYMPIAD_REGISTRATION_IS_COMPLETE(13126),
	// Message: $c1 is currently teleporting and cannot participate in the 3 vs 3
	// Olympiad.
	C1_IS_CURRENTLY_TELEPORTING_AND_CANNOT_PARTICIPATE_IN_THE_3_VS_3_OLYMPIAD(13127),
	// Message: You cannot participate in Team Match while using the Beauty Shop.
	YOU_CANNOT_PARTICIPATE_IN_TEAM_MATCH_WHILE_USING_THE_BEAUTY_SHOP_(13128),
	// Message: You cannot use the Beauty Shop while registering in Team Match.
	YOU_CANNOT_USE_THE_BEAUTY_SHOP_WHILE_REGISTERING_IN_TEAM_MATCH_(13129),
	// Message: You cannot chat while participating in the 3 vs 3 Olympiad.
	YOU_CANNOT_CHAT_WHILE_PARTICIPATING_IN_THE_3_VS_3_OLYMPIAD(13130),
	// Message: You cannot send a whisper to someone who is participating in the 3
	// vs 3 Olympiad.
	YOU_CANNOT_SEND_A_WHISPER_TO_SOMEONE_WHO_IS_PARTICIPATING_IN_THE_3_VS_3_OLYMPIAD(13131),
	// Message: You will be teleported in Team Match within 10 seconds. From that
	// moment, you cannot withdraw.
	YOU_WILL_BE_TELEPORTED_IN_TEAM_MATCH_WITHIN_10_SECONDS_FROM_THAT_MOMENT_YOU_CANNOT_WITHDRAW(13132),
	// Message: You will be teleported in Team Match within several seconds.
	YOU_WILL_BE_TELEPORTED_IN_TEAM_MATCH_WITHIN_SEVERAL_SECONDS(13133),
	// Message: You've received the reward for winning a 3 vs 3 Olympiad match.
	YOUVE_RECEIVED_THE_REWARD_FOR_WINNING_A_3_VS_3_OLYMPIAD_MATCH(13134),
	// Message: You've received the consolation prize for participating in the 3 vs
	// 3 Olympiad.
	YOUVE_RECEIVED_THE_CONSOLATION_PRIZE_FOR_PARTICIPATING_IN_THE_3_VS_3_OLYMPIAD(13135),
	// Message: You added $c1 to your Surveillance List.
	YOU_ADDED_C1_TO_YOUR_SURVEILLANCE_LIST(13354),
	// Message: You deleted $c1 from your Surveillance List.
	YOU_DELETED_C1_FROM_YOUR_SURVEILLANCE_LIST(13355),
	// Message: $c1 from your Surveillance List is online.
	C1_FROM_YOUR_SURVEILLANCE_LIST_IS_ONLINE(13356),
	// Message: $c1 From your Surveillance List is offline.
	C1_FROM_YOUR_SURVEILLANCE_LIST_IS_OFFLINE(13357),
	// Message: Maximum number of people added, you cannot add more.
	MAXIMUM_NUMBER_OF_PEOPLE_ADDED_YOU_CANNOT_ADD_MORE(13358),
	// Message: The character has already been added to the Surveillance List.
	THE_CHARACTER_HAS_ALREADY_BEEN_ADDED_TO_THE_SURVEILLANCE_LIST(13359),
	// Message: That character does not exist.
	THAT_CHARACTER_DOES_NOT_EXIST(13360),
	// Message: You cannot add yourself to your Surveillance List.
	YOU_CANNOT_ADD_YOURSELF_TO_YOUR_SURVEILLANCE_LIST(13361),
	// Message: Not available in combat.
	NOT_AVAILABLE_IN_COMBAT(13363),
	// Message: You've donated $s1.
	YOU_VE_DONATED_S1(13383),
	// Message: $s1 critical donation
	S1_CRITICAL_DONATION(13386),
	// Message: Critical reward of $c1 character $s2
	CRITICAL_REWARD_OF_C1_CHARACTER_S2(13387),
	// Message: $c1 succeeded in a critical action $s2, clan members get a reward.
	C1_SUCCEED_IN_A_CRITICAL_ACTION_S2_CLAN_MEMBERS_GET_A_REWARD(13388),
	// Message: You cannot attack, because you don't have an Elemental Orb.
	YOU_CANNOT_ATTACK_BECAUSE_YOU_DONT_HAVE_AN_ELEMENTAL_ORB(13393),
	// $s1 Honor Coins have been used.
	S1_HONOR_COINS_HAVE_BEEN_USED(13406),
	// Message: $s1 Honor Coins obtained.
	S1_HONOR_COINS_OBTAINED(13408),
	// Message: You cannot transfer your class in a non-peace zone location.
	YOU_CANNOT_TRANSFER_YOUR_CLASS_IN_A_NON_PEACE_ZONE_LOCATION(5236),
	// Message: Only characters of level 70 or higher who have completed the 2nd
	// class transfer can use this command.
	ONLY_CHARACTERS_OF_LEVEL_70_OR_HIGHER_WHO_HAVE_COMPLETED_THE_2ND_CLASS_TRANSFER_CAN_USE_THIS_COMMAND(13002),
	// Message: You can participate in a total of $s1 matches today.
	YOU_CAN_PARTICIPATE_IN_A_TOTAL_OF_S1_MATCHES_TODAY(13005),
	// Message: Stand-by for the game to begin
	STANDBY_FOR_THE_GAME_TO_BEGIN(3021),
	// Message: You must level 70 or higher and have completed the 2nd Class
	// Transfer in order to participate in a match.
	YOU_MUST_LEVEL_70_OR_HIGHER_AND_HAVE_COMPLETED_THE_2ND_CLASS_TRANSFER_IN_ORDER_TO_PARTICIPATE_IN_A_MATCH(5294),
	// Message: Cannot apply to participate in a match while in an instanced zone.
	CANNOT_APPLY_TO_PARTICIPATE_IN_A_MATCH_WHILE_IN_AN_INSTANCED_ZONE(5295),
	// Message: Cannot apply to participate in a match while dead.
	CANNOT_APPLY_TO_PARTICIPATE_IN_A_MATCH_WHILE_DEAD(5296),
	// Message: Cannot apply to participate because your inventory slots or weight
	// exceeded 80%%.
	CANNOT_APPLY_TO_PARTICIPATE_BECAUSE_YOUR_INVENTORY_SLOTS_OR_WEIGHT_EXCEEDED_80(5298),
	// Message: The Secret Supplies of the Balthus Knights arrived! Someone received
	// $s1.
	THE_SECRET_SUPPLIES_OF_THE_BALTHUS_KNIGHTS_ARRIVED_SOMEONE_RECEIVED_S1(6838),
	// Message: Unable to use, because there is no rating info.
	UNABLE_TO_USE_BECAUSE_THERE_IS_NO_RATING_INFO(13330),
	// Message: You've received the reward.
