...
public class Ranger extends DefaultAI
{
	...
	protected void onEvtAttacked(Creature attacker, Skill skill, int damage)
	{
		...
		// int range = (int) ((actor.calculateAttackSpeed() /1000 * actor.getWalkSpeed()
		// )* 0.71); // was "actor.getPhysicalAttackRange()" 0.71 = sqrt(2) / 2
		...
		{
			addTaskMove(posX, posY, posZ, false, false);
