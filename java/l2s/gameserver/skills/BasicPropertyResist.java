...
{
	// The resistance stays no longer than 15 seconds after last mesmerizing debuff.
	...
	/**
	 * Increases the resist level while checking if the resist has expired so it
	 * starts counting it from 1.
	 */
