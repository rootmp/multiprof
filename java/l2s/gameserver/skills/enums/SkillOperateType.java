...
{
	/**
	 * Active Skill with "Instant Abnormal" (for example damage skills
	 * heal/pdam/mdam/cpdam skills).
	 */
	A1,

	/**
	 * Active Skill with "Continuous effect + Instant effect" (for example
	 * buff/debuff or damage/heal over time skills).
	 */
	A2,
	...
	/**
	 * Shooting Active Skill
	 */
	A7,

	/**
	 * Continuous Active Skill with "instant effect" (instant effect casted by
	 * ticks).
	 */
	CA1,
	...
	/**
	 * Continuous Active Skill with "continuous effect" (continuous effect casted by
	 * ticks).
	 */
	CA5,
	 ...
	 * 
	 * @return {@code true} if the operative skill type is active, {@code false}
	 *         otherwise
	 */
	 ...
	 * 
	 * @return {@code true} if the operative skill type is continuous, {@code false}
	 *         otherwise
	 */
	 ...
	 * 
	 * @return {@code true} if the operative skill type is passive, {@code false}
	 *         otherwise
	 */
	 ...
	 * 
	 * @return {@code true} if the operative skill type is toggle, {@code false}
	 *         otherwise
	 */
	 ...
	 * 
	 * @return {@code true} if the operative skill type is active aura,
	...
	/**
	 * @return {@code true} if the operate type skill type should not send messeges
	 *         for start/finish, {@code false} otherwise
	 */
	...
	/**
	 * @return {@code true} if the operate type skill type should not be broadcasted
	 *         as MagicSkillUse, MagicSkillLaunched, {@code false} otherwise
	 */
	 ...
	 * 
	 * @return {@code true} if the operative skill type is channeling, {@code false}
	 *         otherwise
	 */
	 ...
	 * 
	 * @return {@code true} if the operative skill type is synergy, {@code false}
	 *         otherwise
	 */
