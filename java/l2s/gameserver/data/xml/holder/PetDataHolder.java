...
public final class PetDataHolder extends AbstractHolder
{
	...
	private static final List<PetData> _allTemplates = new ArrayList<>();
	private final List<Integer> idsOfEvolveLevelNonePets = Arrays.asList(16104, 16079, 16084, 16089, 16094, 16099);
