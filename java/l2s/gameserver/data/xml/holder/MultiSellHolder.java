...
public class MultiSellHolder extends AbstractHolder
{
	...
	public void SeparateAndSend(int listId, Player player, double taxRate)
	{
		...
		{
			windowType = MultiSellListPacket.WindowType.NORMAL;
		}

		SeparateAndSend(list, player, taxRate, windowType);
	}

	public void SeparateAndSend(MultiSellListContainer list, Player player, double taxRate, MultiSellListPacket.WindowType windowType)
	{
		...
		player.sendPacket(new MultiSellListPacket(temp, page, 1, windowType));
	}
