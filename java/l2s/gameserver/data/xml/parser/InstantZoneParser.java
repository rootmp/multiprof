...
public class InstantZoneParser extends AbstractParser<InstantZoneHolder>
{
	...
	{
		return new File(Config.DATAPACK_ROOT, "data/parser/instances/");
	}
	...
	protected void readData(Element rootElement) throws Exception
	{
		for (Iterator<Element> iterator = rootElement.elementIterator(); iterator.hasNext();)
		{
			...
			// 0 - точечный, в каждой указанной точке; 1 - один точечный спаун в рандомной
			// точке; 2 - локационный
			int spawnType = 0;
			...
			int minLevel = 0, maxLevel = 0, minParty = 1, maxParty = Party.MAX_SIZE;
