...
/**
 * Created with IntelliJ IDEA. User: camelion Date: 12/23/12 Time: 1:36 PM To
 * change this template use File | Settings | File Templates.
 */
public class ManualPchLinker
{
	private static final Logger LOGGER = LoggerFactory.getLogger(ManualPchLinker.class);
	...
	public void load()
	{
		try
		{
			BufferedReader br = Files.newBufferedReader(Config.DATAPACK_ROOT.toPath().resolve(MANUAL_PCH_FILE_NAME), Charset.forName("UTF-16"));
			String line;
