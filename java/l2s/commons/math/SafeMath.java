...
public class SafeMath
{
	 ...
	 * @param a слагаемое
	 * @param b слагаемое
	 * @return сумму <code>a+b</code>, либо граничное значение целого, в случае
	 *         переполнения
	 */
	 ...
	 * @param a множитель
	 * @param b множитель
	 * @return произведение <code>a*b</code>, либо граничное значение целого, в
	 *         случае переполнения
	 */
	...
	/**
	 * Умножение двух натуральных чисел с проверкой на переполнение.
	 *
	 * @param a множитель
	 * @param b множитель
	 * @return произведение <code>a*b</code>
