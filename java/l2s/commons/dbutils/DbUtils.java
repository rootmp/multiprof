...
public class DbUtils
{
	...
	/**
	 * Close a <code>Statement</code> and <code>ResultSet</code>, avoid closing if
	 * null.
	 *
	 * @param stmt Statement to close.
	 * @param rs   ResultSet to close.
	...
	/**
	 * Close a <code>Connection</code> and <code>Statement</code>. Avoid closing if
	 * null and hide any SQLExceptions that occur.
	 *
	 * @param conn Connection to close.
	 * @param stmt Statement to close.
	 */
