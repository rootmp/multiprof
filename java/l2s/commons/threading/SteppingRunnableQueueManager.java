...
public abstract class SteppingRunnableQueueManager implements Runnable
{
	 ...
	 * @return SteppingScheduledFuture управляющий объект, отвечающий за выполенение
	 *         задачи
	 */
	...
	/**
	 * Запланировать выполнение задачи через равные промежутки времени, с начальной
	 * задержкой
	 * 
	 * @param r       задача для выполнения
	 ...
	 * результат будет равен 1 если delay больше шага выполнения, результат будет
	 * результатом округления от деления delay / step
	 */
