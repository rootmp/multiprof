...
public class PrintfFormat
{
	 ...
	 * or followed by ordinary strings. Control strings begin with unpaired percent
	 * signs. A pair of successive percent signs designates a single percent sign in
	 * the format.
	 * 
	 ...
	 * @param start Position in the string <code>s</code> to begin looking for the
	 *              start of a control string.
	 * @return the substring from the start position to the beginning of the control
	 *         string.
	 */
	 ...
	 * @return The formatted String.
	 * @exception IllegalArgumentException if the conversion character is f, e, E,
	 *                                     g, G, s, or S.
	 */
	 ...
	 * @return The formatted String.
	 * @exception IllegalArgumentException if the conversion character is c, C, s,
	 *                                     S, d, d, x, X, or o.
	 */
	 ...
	 * @return The formatted String.
	 * @exception IllegalArgumentException if the conversion character is neither s
	 *                                     nor S.
	 */
	 ...
	 *                                     inappropriate for formatting an unwrapped
	 *                                     value.
	 */
	...
	/**
	 * <p>
	 * ConversionSpecification allows the formatting of a single primitive or object
	 * embedded within a string. The formatting is controlled by a format string.
	 * Only one Java primitive or object can be formatted at a time.
	 * <p>
	 * A format string is a Java string that contains a control string. The control
	 * string starts at the first percent sign (%) in the string, provided that this
	 * percent sign
	 * <ol>
	 * <li>is not escaped protected by a matching % or is not an escape % character,
	 * <li>is not at the end of the format string, and
	 ...
	 * minimum number of exponent digits is 3 instead of 2 for e and E formats when
	 * the optional L is used before the e, E, g, or G conversion character. The
	...
	private class ConversionSpecification
	{
		...
		/**
		 * Constructor for a conversion specification. The argument must begin with a %
		 * and end with the conversion character for the conversion specification.
		 * 
		 * @param fmtArg String specifying the conversion specification.
		 * @exception IllegalArgumentException if the input string is null, zero length,
		...
		/**
		 * Get the conversion character that tells what type of control character this
		 * instance has.
		 *
		...
		/**
		 * Check whether the specifier has a variable field width that is going to be
		 * set by an argument.
		 * 
		 * @return <code>true</code> if the conversion uses an * field width; otherwise
		 *         <code>false</code>.
		 */
		...
		/**
		 * Set the field width with an argument. A negative field width is taken as a -
		...
		/**
		 * Check whether the specifier has a variable precision that is going to be set
		 * by an argument.
		 * 
		 * @return <code>true</code> if the conversion uses an * precision; otherwise
		 *         <code>false</code>.
		 */
		...
		/**
		 * Set the precision with an argument. A negative precision will be changed to
		 * zero.
		 * 
		...
		/**
		 * For f format, the flag character '-', means that the output should be left
		 * justified within the field. The default is to pad with blanks on the left.
		 * '+' character means that the conversion will always begin with a sign (+ or
		 * -). The blank flag character means that a non-negative input will be preceded
		 * with a blank. If both a '+' and a ' ' are specified, the blank flag is
		 * ignored. The '0' flag character implies that padding to the field width will
		 * be done with zeros instead of blanks. The field width is treated as the
		 * minimum number of characters to be printed. The default is to add no padding.
		 * Padding is with blanks by default. The precision, if set, is the number of
		 * digits to appear after the radix character. Padding is with trailing 0s.
		 */
		...
		/**
		 * An intermediate routine on the way to creating an f format String. The method
		 * decides whether the input double value is an infinity, not-a-number, or a
		...
		/**
		 * For e format, the flag character '-', means that the output should be left
		 * justified within the field. The default is to pad with blanks on the left.
		 * '+' character means that the conversion will always begin with a sign (+ or
		 * -). The blank flag character means that a non-negative input will be preceded
		 * with a blank. If both a '+' and a ' ' are specified, the blank flag is
		 ...
		 * be done with zeros instead of blanks. The field width is treated as the
		 * minimum number of characters to be printed. The default is to add no padding.
		 * Padding is with blanks by default. The precision, if set, is the minimum
		 * number of digits to appear after the radix character. Padding is with
		 * trailing 0s. The behavior is like printf. One (hopefully the only) exception
		 * is that the minimum number of exponent digits is 3 instead of 2 for e and E
		 ...
		 * @param icarry the index of the first digit that is to be truncated from the
		 *               print
		 * @return <code>true</code> if the truncation forces a round that will change
		 *         the print
		 */
		...
		/**
		 * Start the symbolic carry process. The process is not quite finished because
		 * the symbolic carry may change the length of the string and change the
		 * exponent (in e format).
		 * 
		 * @param cLast  index of the last digit changed by the round
		 * @param cFirst index of the first digit allowed to be changed by this phase of
		 *               the round
		 * @return <code>true</code> if the carry forces a round that will change the
		 *         print still more
		 */
		...
		/**
		 * An intermediate routine on the way to creating an e format String. The method
		 * decides whether the input double value is an infinity, not-a-number, or a
		 * finite double and formats each type of input appropriately.
		 * 
		 * @param x     the double value to be formatted.
		 ...
		 * character '-', means that the output should be left justified within the
		 * field. The default is to pad with blanks on the left. '+' character means
		 * that the conversion will always begin with a sign (+ or -). The blank flag
		 * character means that a non-negative input will be preceded with a blank. If
		 * both a '+' and a ' ' are specified, the blank flag is ignored. The '0' flag
		 * character implies that padding to the field width will be done with zeros
		 * instead of blanks. The field width is treated as the minimum number of
		 * characters to be printed. The default is to add no padding. Padding is with
		 * blanks by default. The precision, if set, is the minimum number of digits to
		...
		/**
		 * Format method for the d conversion specifer and short argument. For d format,
		 * the flag character '-', means that the output should be left justified within
		 * the field. The default is to pad with blanks on the left. A '+' character
		 * means that the conversion will always begin with a sign (+ or -). The blank
		 * flag character means that a non-negative input will be preceded with a blank.
		 * If both a '+' and a ' ' are specified, the blank flag is ignored. The '0'
		 * flag character implies that padding to the field width will be done with
		 * zeros instead of blanks. The field width is treated as the minimum number of
		 * characters to be printed. The default is to add no padding. Padding is with
		 * blanks by default. The precision, if set, is the minimum number of digits to
		 * appear. Padding is with leading 0s.
		 * 
		...
		/**
		 * Format method for the d conversion character and long argument. For d format,
		 * the flag character '-', means that the output should be left justified within
		 * the field. The default is to pad with blanks on the left. A '+' character
		 * means that the conversion will always begin with a sign (+ or -). The blank
		 * flag character means that a non-negative input will be preceded with a blank.
		...
		/**
		 * Format method for the d conversion character and int argument. For d format,
		 * the flag character '-', means that the output should be left justified within
		 * the field. The default is to pad with blanks on the left. A '+' character
		 * means that the conversion will always begin with a sign (+ or -). The blank
		 * flag character means that a non-negative input will be preceded with a blank.
		 ...
		 * 
		 * @param sx the String to format, the result of converting a short, int, or
		 *           long to a String.
		 * @return the formatted String.
		 */
		 ...
		 * justified within the field. The default is to pad with blanks on the left.
		 * The '#' flag character means to lead with '0x'. The field width is treated as
		 * the minimum number of characters to be printed. The default is to add no
		 * padding. Padding is with blanks by default. The precision, if set, is the
		 * minimum number of digits to appear. Padding is with leading 0s.
		 * 
		 * @param x the short to format.
		 * @return the formatted String.
		 */
		...
		/**
		 * Format method for the x conversion character and long argument. For x format,
		 * the flag character '-', means that the output should be left justified within
		 * the field. The default is to pad with blanks on the left. The '#' flag
		 * character means to lead with '0x'. The field width is treated as the minimum
		 * number of characters to be printed. The default is to add no padding. Padding
		 * is with blanks by default. The precision, if set, is the minimum number of
		...
		/**
		 * Format method for the x conversion character and int argument. For x format,
		 * the flag character '-', means that the output should be left justified within
		 * the field. The default is to pad with blanks on the left. The '#' flag
		 * character means to lead with '0x'. The field width is treated as the minimum
		 * number of characters to be printed. The default is to add no padding. Padding
		 ...
		 * format, the flag character '-', means that the output should be left
		 * justified within the field. The default is to pad with blanks on the left.
		 * The '#' flag character means that the output begins with a leading 0 and the
		 * precision is increased by 1. The field width is treated as the minimum number
		 * of characters to be printed. The default is to add no padding. Padding is
		 * with blanks by default. The precision, if set, is the minimum number of
		 * digits to appear. Padding is with leading 0s.
		 * 
		 * @param x the short to format.
		 * @return the formatted String.
		...
		/**
		 * Format method for the o conversion character and long argument. For o format,
		 * the flag character '-', means that the output should be left justified within
		 * the field. The default is to pad with blanks on the left. The '#' flag
		 * character means that the output begins with a leading 0 and the precision is
		 * increased by 1. The field width is treated as the minimum number of
		 * characters to be printed. The default is to add no padding. Padding is with
		 * blanks by default. The precision, if set, is the minimum number of digits to
		 * appear. Padding is with leading 0s.
		 * 
		...
		/**
		 * Format method for the o conversion character and int argument. For o format,
		 * the flag character '-', means that the output should be left justified within
		 * the field. The default is to pad with blanks on the left. The '#' flag
		 * character means that the output begins with a leading 0 and the precision is
		 * increased by 1. The field width is treated as the minimum number of
		...
		/**
		 * Format method for the c conversion character and char argument. The only flag
		 * character that affects c format is the '-', meaning that the output should be
		 * left justified within the field. The default is to pad with blanks on the
		 * left. The field width is treated as the minimum number of characters to be
		 * printed. Padding is with blanks by default. The default width is 1. The
		 * precision, if set, is ignored.
		 * 
		...
		/**
		 * Format method for the s conversion character and String argument. The only
		 * flag character that affects s format is the '-', meaning that the output
		 * should be left justified within the field. The default is to pad with blanks
		 * on the left. The field width is treated as the minimum number of characters
		 * to be printed. The default is the smaller of the number of characters in the
		 * the input and the precision. Padding is with blanks by default. The
		 * precision, if set, specifies the maximum number of characters to be printed
		 * from the string. A null digit string is treated as a 0. The default is not to
		 * set a maximum number of characters to be printed.
		 * 
		 * @param x the String to format.
		 * @return the formatted String.
		 */
		...
		private boolean setConversionCharacter()
		{
			...
			if(pos < fmt.length())
			{
				...
				if(c == 'i' || c == 'd' || c == 'f' || c == 'g' || c == 'G' || c == 'o' || c == 'x' || c == 'X' || c == 'e' || c == 'E' || c == 'c'
						|| c == 's' || c == '%')
				{
		 ...
		 * number of digits in an exponent when using floating point formats. An l or h
		 * is used to control conversion of the input to a long or short, respectively,
		 * before formatting. If any of these is present, store them.
		 */
		...
		/**
		 * The integer portion of the result of a decimal conversion (i, d, u, f, g, or
		 * G) will be formatted with thousands' grouping characters. For other
		...
		/**
		 * For an o conversion, increase the precision to force the first digit of the
		 * result to be a zero. For x (or X) conversions, a non-zero result will have 0x
		 * (or 0X) prepended to it. For e, E, f, g, or G conversions, the result will
		 * always contain a radix character, even if no digits follow the point. For g
		 ...
		 * conversions. The number of digits to appear after the radix character for the
		 * e, E, and f conversions. The maximum number of significant digits for the g
		 * and G conversions. The maximum number of bytes to be printed from a string in
		 * s and S conversions.
		 */
