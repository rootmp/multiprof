 ...
 * @author nexvill
 */
public class KingProcellaExtreme extends Reflection
{
								...
								if (npc.getNpcId() == PROCELLA)
								{
									if (player.getDistance3D(npc) < 300)
									{
										...
										if (!player.getAbnormalList().contains(50043))
										{
											...
											npc.doCast(HURRICANE_BOLT_LV_2, player, true);
										}
									}
								}
							}
	...
	// Npcs
	private static final int PROCELLA = 29122;
	private static final int PROCELLA_GUARDIAN_1 = 29127;
	private static final int PROCELLA_GUARDIAN_2 = 29128;
	private static final int PROCELLA_GUARDIAN_3 = 29129;
	private static final int PROCELLA_STORM = 29130;
	// Skills
	private static final SkillEntry HURRICANE_SUMMON = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 50042, 1);
	private static final SkillEntry HURRICANE_BOLT_LV_2 = SkillEntry.makeSkillEntry(SkillEntryType.NONE, 50043, 2);
	// Misc
	...
	{
		_instanceZone = getZone("[king_procella_extreme]");
