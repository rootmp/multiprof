					...
					else
					{
						...
						switch (i)
						{
							...
							case 12:
								...
								break;
							case 13:
								actor.dropItem(actor.getPlayer(), 70135, 1); // Сундук Производства Набедренников Синего
																				// Волка
								break;
							case 14:
								...
								break;
							case 15:
								actor.dropItem(actor.getPlayer(), 70137, 1); // Сундук Производства Перчаток Синего
																				// Волка
								break;
							case 16:
								...
								break;
							case 17:
								actor.dropItem(actor.getPlayer(), 70139, 1); // Сундук Производства Кожаного Доспеха
																				// Рока
								break;
						}
					}
			...
			else if (npcId == kg_small_adult_gourd)
			{
				...
				if (Rnd.chance(5))
				{
					...
					else
					{
						...
						{
							dropedCount++;
							actor.dropItem(actor.getPlayer(), 6576, 1); // Благословенный Свиток: Модифицировать Доспех
																		// (D)
						}
						else if (Rnd.chance(15))
						{
							dropedCount++;
							actor.dropItem(actor.getPlayer(), 6575, 1); // Благословенный Свиток: Модифицировать Оружие
																		// (D)
						}
						else if (Rnd.chance(10))
						{
							dropedCount++;
							actor.dropItem(actor.getPlayer(), 6574, 1); // Благословенный Свиток: Модифицировать Доспех
																		// (C)
						}
						else if (Rnd.chance(5))
						{
							dropedCount++;
							actor.dropItem(actor.getPlayer(), 6573, 1); // Благословенный Свиток: Модифицировать Оружие
																		// (C)
						}
					}
				}
			...
			else if (npcId == kg_big_adult_gourd)
			{
				...
				if (Rnd.chance(15))
				{
					if (Rnd.chance(60))
					{
						...
						{
							dropedCount++;
							actor.dropItem(actor.getPlayer(), 6571, 1); // Благословенный Свиток: Модифицировать Оружие
																		// (B)
						}
					}
					else
					{
						if (Rnd.chance(60))
						{
							...
							{
								dropedCount++;
								actor.dropItem(actor.getPlayer(), 33813, 1); // Улучшенный Свиток: Модифицировать Доспех
																				// (С)
							}
							else if (Rnd.chance(15))
							{
								dropedCount++;
								actor.dropItem(actor.getPlayer(), 33807, 1); // Улучшенный Свиток: Модифицировать Оружие
																				// (С)
							}
							else if (Rnd.chance(10))
							{
								dropedCount++;
								actor.dropItem(actor.getPlayer(), 33814, 1); // Улучшенный Свиток: Модифицировать Доспех
																				// (B)
							}
							else if (Rnd.chance(5))
							{
								dropedCount++;
								actor.dropItem(actor.getPlayer(), 33808, 1); // Улучшенный Свиток: Модифицировать Оружие
																				// (B)
							}
						}
						else
						{
							...
							{
								dropedCount++;
								actor.dropItem(actor.getPlayer(), 49483, 1); // Стабильный Свиток: Модифицировать Доспех
																				// (C)
							}
							else if (Rnd.chance(15))
							{
								dropedCount++;
								actor.dropItem(actor.getPlayer(), 49484, 1); // Стабильный Свиток: Модифицировать Оружие
																				// (C)
							}
							else if (Rnd.chance(10))
							{
								dropedCount++;
								actor.dropItem(actor.getPlayer(), 49485, 1); // Стабильный Свиток: Модифицировать Доспех
																				// (B)
							}
							else if (Rnd.chance(5))
							{
								dropedCount++;
								actor.dropItem(actor.getPlayer(), 49486, 1); // Стабильный Свиток: Модифицировать Оружие
																				// (B)
							}
						}
					}
						...
						if (Rnd.chance(90))
						{
							...
							switch (i)
							{
								...
								case 7:
									...
									break;
								case 8:
									actor.dropItem(actor.getPlayer(), 70130, 1); // Сундук Производства Латного Доспеха
																					// Рока
									break;
								case 9:
									actor.dropItem(actor.getPlayer(), 70131, 1); // Сундук Производства Шлема Рока
								...
								case 11:
									...
									break;
								case 12:
									actor.dropItem(actor.getPlayer(), 70134, 1); // Сундук Производства Кирасы Синего
																					// Волка
									break;
								case 13:
									actor.dropItem(actor.getPlayer(), 70135, 1); // Сундук Производства Набедренников
																					// Синего Волка
									break;
								case 14:
									actor.dropItem(actor.getPlayer(), 70136, 1); // Сундук Производства Шлема Синего
																					// Волка
									break;
								case 15:
									actor.dropItem(actor.getPlayer(), 70137, 1); // Сундук Производства Перчаток Синего
									...
									break;
								case 16:
									actor.dropItem(actor.getPlayer(), 70138, 1); // Сундук Производства Сапог Синего
																					// Волка
									break;
								case 17:
									actor.dropItem(actor.getPlayer(), 70139, 1); // Сундук Производства Кожаного Доспеха
