 ...
 * @author nexvill
 */
public class _10297_MemoryOfTheGloriousPast extends Quest
{
	// Npcs
	...
	private static final int[] MOBS =
	{
		...
		22102 // Guard of Honor
	};

	// Items
	private static final int SOE_ORVEN = 91768;
	private static final int SOE_PLAINS_OF_GLORY = 95593;
	...
	public _10297_MemoryOfTheGloriousPast()
	{
		super(PARTY_ONE, ONETIME);
		addStartNpc(ORVEN);
		addTalkId(ORVEN);
		addKillNpcWithLog(1, NpcString.KILL_MONSTERS_ON_THE_PLAINS_OF_GLORY.getId(), A_LIST, 500, MOBS);
		addLevelCheck("bad_level.htm", 56, 64);
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		switch (event)
		{
			case "orven_q10297_04.htm":
			{
				st.setCond(1);
				st.giveItems(SOE_PLAINS_OF_GLORY, 1);
				break;
			}
			case "orven_q10297_07.htm":
			{
		...
		switch (npcId)
		{
			case ORVEN:
			{
				switch (cond)
				{
					case 0:
					{
						return "orven_q10297_01.htm";
					}
					case 1:
					{
						return "orven_q10297_05.htm";
					}
					case 2:
					{
						return "orven_q10297_06.htm";
					}
				}
				break;
			}
