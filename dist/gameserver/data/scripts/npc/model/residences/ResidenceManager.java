...
public abstract class ResidenceManager extends MerchantInstance
{
	...
	private void useSkill(int id, int level, Player player)
	{
		...
		if (skill.getMpConsume() < getCurrentMp())
		{
			...
			{
				altUseSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, skill), player);
				HtmlMessage html = new HtmlMessage(this);
	...
	private void checkAdditionalSupportSkill()
	{
		...
		if (function != null)
		{
			...
			{
				case 1:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_1, 1));
					break;
				case 2:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_2, 1));
					break;
				case 3:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_3, 1));
					break;
				case 4:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_4, 1));
					break;
				case 5:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_5, 1));
					break;
				case 6:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_6, 1));
					break;
				case 7:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_7, 1));
					break;
				case 8:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_8, 1));
					break;
				case 9:
					addSkill(SkillEntry.makeSkillEntry(SkillEntryType.NONE, CH_BLESSING_SKIL_ID_9, 1));
					break;
			}
		}
		refreshHpMpCpDpBp();
