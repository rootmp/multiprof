...
public class SchemeBufferInstance extends NpcInstance
{
	...
	private String main(final Player player)
	{
		...
		// int td=0;
		// String[] TRS = {"<table width=100% border=0 cellspacing=0 cellpadding=1
		// bgcolor=444444><tr><td height=25>", "</td>", "<td height=25>",
		// "</td></tr></table>"};
		...
		/*
		 * if (MESSAGE.length() > 0) { MAIN_HTML_MESSAGE +=
		 * "<BR1><table width=100% border=0 cellspacing=0 cellpadding=1 bgcolor=444444><tr>"
		 * +
		 * "<td><font color=00FFFF>Buffs:</font></td><td align=right>...</td></tr></table>"
		 * + "<BR1><table cellspacing=0 cellpadding=0>" + MESSAGE + "</table>"; MESSAGE
		 * = ""; td = 0; }
		 */
		 ...
		 * "<BR1><table width=100% border=0 cellspacing=0 cellpadding=1 bgcolor=444444><tr>"
		 * +
		 * "<td><font color=00FFFF>Preset:</font></td><td align=right><font color=LEVEL>"
		 * + Util.formatAdena(BUFF_SET_PRICE) + "</font> adena</td></tr></table>" +
		 * "<BR1><table cellspacing=0 cellpadding=0>" + MESSAGE + "</table>"; MESSAGE =
		 * ""; td = 0; }
		 */
		...
		for (int i = start; i < end; ++i)
		{
			...
			if (action.equals("add"))
			{
				if (!isUsed(scheme, id, level))
				{
					...
					HTML_MESSAGE += "<tr><td width=35>" + getSkillIconHtml(id, level) + "</td><td fixwidth=170>" + name + "</td><td><button value=\"Add\" action=\"bypass -h npc_%objectId%_add_buff " + scheme + "_" + id + "_" + level + " " + page + " " + TOTAL_BUFF + "\" width=65 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" + "</tr></table>";
					k += 1;
				}
			}
			else if (action.equals("remove"))
			{
				if (k % 2 != 0)
					...
					HTML_MESSAGE += "<BR1><table border=0 bgcolor=292929>";
				HTML_MESSAGE += "<tr><td width=35>" + getSkillIconHtml(id, level) + "</td><td fixwidth=170>" + name + "</td><td><button value=\"Remove\" action=\"bypass -h npc_%objectId%_remove_buff " + scheme + "_" + id + "_" + level + " " + page + " " + TOTAL_BUFF + "\" width=65 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" + "</table>";
				k += 1;
			}
		}
		HTML_MESSAGE += "<br><br><button value=\"Back\" action=\"bypass -h npc_%objectId%_manage_scheme_select " + scheme + " x x\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h npc_%objectId%_redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + TITLE_NAME + "</font></center>";
		return HTML_MESSAGE;
	} // viewAllSchemeBuffs
	...
	private String deleteScheme(Player player)
	{
		...
		HTML += "<br><button value=\"Back\" action=\"bypass -h npc_%objectId%_redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + TITLE_NAME + "</font></center>";
		return HTML;
	}
	...
	private String buildHtml(String buffType)
	{
		...
		HTML_MESSAGE += "<br><button value=\"Back\" action=\"bypass -h npc_%objectId%_redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + TITLE_NAME + "</font></center>";
		return HTML_MESSAGE;
	}
	...
	private String getOptionList(String scheme)
	{
		...
		HTML += "<br><button value=\"Back\" action=\"bypass -h npc_%objectId%_edit_1 0 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h npc_%objectId%_redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + TITLE_NAME + "</font></center>";
		return HTML;
	}
	...
	private String viewAllBuffTypes()
	{
		...
		HTML_MESSAGE += "<button value=\"Back\" action=\"bypass -h npc_%objectId%_redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + TITLE_NAME + "</font></center>";
		return HTML_MESSAGE;
	}

	private String createScheme()
	{
		return "<head>" + TITLE_NAME + "</head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br><br>You MUST seprerate new words with a dot (.)<br><br>Scheme name: <edit var=\"name\" width=100><br><br>" + "<button value=\"Create Scheme\" action=\"bypass -h npc_%objectId%_create $name no_name x x\" width=200 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><button value=\"Back\" action=\"bypass -h npc_%objectId%_redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + TITLE_NAME + "</font></center>";
	}
	...
	private String viewAllBuffs(String type, String typeName, String page)
	{
		...
		for (int i = start; i < end; ++i)
		{
			...
			if (type.equals("set"))
			{
				...
				HTML_MESSAGE += "<tr><td fixwidth=145>" + name + "</td><td width=70><combobox var=\"newSet" + i + "\" width=70 " + listOrder + "></td>" + "<td width=50><button value=\"Update\" action=\"bypass -h npc_%objectId%_changeBuffSet " + skillPos + " $newSet" + i + " " + page + "\" width=50 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>";
			}
			else
			{
		...
		HTML_MESSAGE += "<br><br><button value=\"Back\" action=\"bypass -h npc_%objectId%_redirect manage_buffs 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h npc_%objectId%_redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + TITLE_NAME + "</font></center>";
		return HTML_MESSAGE;
	}
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if (eventParam0.equalsIgnoreCase("buffpet"))
		{
			if (System.currentTimeMillis() / 1000 > player.getblockUntilTime())
			{
				...
				if (TIME_OUT)
					addTimeout(player, SetupGaugePacket.Colors.GREEN, TIME_OUT_TIME / 2, 600);
			}
			...
			if ((int) (System.currentTimeMillis() / 1000) > player.getblockUntilTime())
			{
				...
				if (!getpetbuff)
				{
					if (eventParam3.equals("cubic"))
					{
						...
						SkillEntry skillEntry = SkillEntry.makeSkillEntry(SkillEntryType.NONE, Integer.parseInt(eventParam1), Integer.parseInt(eventParam2));
						if (skillEntry != null)
							player.callSkill(player, skillEntry, new HashSet<Creature>(Arrays.asList(player)), false, false);
					}
					else
					{
		...
		{
			msg.setHtml("<html><head>" + TITLE_NAME + "</head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>Do you really want to delete '" + eventParam2 + "' scheme?<br><br>" + "<button value=\"Yes\" action=\"bypass -h npc_%objectId%_delete " + eventParam1 + " x x\" width=50 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"No\" action=\"bypass -h npc_%objectId%_delete_1 x x x\" width=50 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + TITLE_NAME + "</font></center></body></html>");
		}
