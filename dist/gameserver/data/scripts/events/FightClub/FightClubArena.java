...
public class FightClubArena extends FightClubManager implements OnDeathListener, OnPlayerExitListener
{
	...
	private void initBattle()
	{
		...
		ThreadPoolManager.getInstance().schedule(() -> FightClubManager.resurrectPlayers(player1, player2, reflection), (Config.ARENA_TELEPORT_DELAY * 1000 - 600));
		ThreadPoolManager.getInstance().schedule(() -> FightClubManager.healPlayers(player1, player2, this.reflection), (Config.ARENA_TELEPORT_DELAY * 1000 - 500));
		ThreadPoolManager.getInstance().schedule(() -> FightClubManager.teleportPlayersToColliseum(player1, player2, reflection), (Config.ARENA_TELEPORT_DELAY * 1000));
	}
	...
	private void giveReward(Player player)
	{
		...
		ItemFunctions.addItem(player, itemId, itemCount * 2, true);
	}
